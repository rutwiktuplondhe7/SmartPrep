...
def train():
    ...
    SAVE_PATH = os.path.join(BASE_DIR, "models", "smartprep_regression_lstm_unfrozen.pt")
    ...
    # Load pretrained backbone safely
    ...
    optimizer = optim.Adam(
        list(model.lstm.parameters()) + list(model.fc.parameters()),
        lr=LR
    )
    ...
    print("LSTM-unfrozen regression model saved safely.")
